...
# ѕусть при каждом создании записи в таблицах users, catalogs и products в таблицу logs помещаетс€ 
...
# =====================================================================================
# 2.
# (по желанию) —оздайте SQL-запрос, который помещает в таблицу users миллион записей.
...
CREATE PROCEDURE users_create_big_data (IN count_rows INT)
  BEGIN 
	...
	WHILE count_rows > 0 DO
		# ƒобавил чтоб пользователи хоть немного различались	
...
# ¬ызываем процедуру дл€ создани€ миллиона записей
